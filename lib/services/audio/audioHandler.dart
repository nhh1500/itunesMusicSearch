...
abstract class AudioPlayerHandler implements AudioHandler {
  ...
  Stream<MediaItem?>? get currentSourceStream;
  ...
  QueueState? get currentQueueState;
...
class AudioPlayerHandlerImpl extends BaseAudioHandler
  ...
  MediaItem? _currentSource;
  QueueState? _currentQueueState;
  // ignore: close_sinks
  ...
  @override
  Stream<MediaItem?> get currentSourceStream => Rx.combineLatest5<int?,
              List<MediaItem>, bool, List<int>?, Duration?, MediaItem?>(
  ...
  @override
  MediaItem? get currentSource => _currentSource;

  @override
  QueueState? get currentQueueState => _currentQueueState;
  ...
  Future<void> _init() async {
    ...
    queueState.listen((event) {
      _currentQueueState = event;
    });
  ...
  AudioSource _itemToSource(MediaItem mediaItem) {
    final audioSource = LockCachingAudioSource(Uri.parse(mediaItem.id));
  ...
  Future<void> onNotificationDeleted() async {
    print('onNotificationDeleted Called');
    await _player.stop();
  }
